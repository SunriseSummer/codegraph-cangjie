'use strict';
//
// Programmatic / embedded SDK entry for @cangjie-lang/codegraph (issue #354).
//
...
// API — `require("@cangjie-lang/codegraph")` returning the CodeGraph class et al.
//
// The compiled library + its production dependencies (web-tree-sitter,
// tree-sitter-wasms, …) ship INSIDE the per-platform bundle, at
//   @cangjie-lang/codegraph-<platform>-<arch>/lib/dist/index.js
...
var pkg = '@cangjie-lang/codegraph-' + target;
...
function resolveLibrary() {
  ...
  throw new Error(
    ...
    '      npm i @cangjie-lang/codegraph --registry=https://registry.npmjs.org\n' +
    '  - or run the CLI once (e.g. `npx @cangjie-lang/codegraph status`) to\n' +
