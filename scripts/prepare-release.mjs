...
/**
 * Append a `[X.Y.Z]: https://github.com/SunriseSummer/codegraph-cangjie/releases/tag/vX.Y.Z`
...
function appendLinkRef(text, version) {
  const refLine = `[${version}]: https://github.com/SunriseSummer/codegraph-cangjie/releases/tag/v${version}`;
