...
$repo = 'SunriseSummer/codegraph-cangjie'
...
# Most often a stale `npm i -g @cangjie-lang/codegraph`, whose launcher keeps
...
if ($shadow) {
  ...
  Write-Warning "(e.g. 'npm rm -g @cangjie-lang/codegraph') or put '$binDir' first on your PATH."
}
