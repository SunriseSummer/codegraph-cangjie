...
> See the v0.9.5 release notes for the [staleness banner (#403)](https://github.com/SunriseSummer/codegraph-cangjie/releases/tag/v0.9.5) and the connect-time catch-up (#414); both shipped together.
